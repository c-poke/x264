/**
 * $URL: https://gpac.svn.sourceforge.net/svnroot/gpac/trunk/gpac/applications/osmo4_android/src/com/gpac/Osmo4/GPACInstance.java $
 *
 * $LastChangedBy: jeanlf $ - $LastChangedDate: 2012-04-13 17:14:30 +0200 (ven. 13 avril 2012) $
 */
    ...
    synchronized static Map<String, Throwable> loadAllLibraries(GpacConfig config) {
        ...
        if (!exceptions.isEmpty()) {
            try {
                ...
                out.println("$Revision: 4019 $"); //$NON-NLS-1$
